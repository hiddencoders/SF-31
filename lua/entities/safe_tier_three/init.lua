...
function ENT:Initialize()	
	...
	self:SetAmount(0)
		...
		self.Safe.CanBeOpenedWith["crowbar"] = true			// Can you open it with: "crowbar", "keypad", "blowtorch"
		self.Safe.CanBeOpenedWith["keypad"] = true
		self.Safe.CanBeOpenedWith["blowtorch"] = true
		self.Safe.ToOpenedWith["crowbar"] = {5,10}			// How many times you have to try open the safe {minimum, maximum} with this. If it's between you MIGHT get it open. Keep the curly brackets!
		self.Safe.ToOpenedWith["keypad"] = {3,11}
		...
		self.InterestRate = 5							// Interest rate in percentage
